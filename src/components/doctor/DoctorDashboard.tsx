...
const AllAppointments = () => {
  ...
  const acceptRequest = async (apt: any) => {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row lg:justify-between gap-3 py-3 lg:py-0 lg:min-h-16">
            ...
            <div className="flex flex-wrap items-center gap-3">
              <span className="text-sm text-gray-600 break-all">Dr. {user?.email?.split('@')[0]}</span>
